...
import 'package:app_flutter/telas_ghost/projeto_ghost.dart';
...
class MinhaApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: OrganizacaoPageGhost(),
    );
  }
}

class OrganizacaoPageGhost extends StatelessWidget {
                              ...
                              TextButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DetalhesProjetoPageGhost(projeto),
                                    ),
                                  );
                                },
                                child: Text("Ver mais"),
